...
export const emptyTask = (id = `task-${Date.now()}`) => ({
  ...
  expectedResult: '', successCriteria: '', businessContact: '', interactionFormat: '', topic: 'Другое',
  score: 0, readinessLevel: 'Draft', status: TASK_STATUS.DRAFT, confirmed: false, confirmedFields: [], createdAt: new Date().toISOString(),
});
